            ...
            <div class="lg:col-span-2">
                ...
                <div class="space-y-3">
                    <div class="flex items-center space-x-3">
                        <svg class="w-7 h-7 text-[#00b6b4]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="mt-12 pt-8 border-t border-gray-300 dark:border-[#333333]">
            <div class="flex flex-row justify-between items-center footer-bottom">
                ...
                <div class="flex space-x-6 text-sm">
                    <a href="/terms" class="text-[#cccccc] hover:text-[#00b6b4] transition-colors duration-200">
                        Conditions d'utilisation
                    </a>
                    <a href="/privacy" class="text-[#cccccc] hover:text-[#00b6b4] transition-colors duration-200">
                        Politique de confidentialité
                    </a>
                    <a href="/legal" class="text-[#cccccc] hover:text-[#00b6b4] transition-colors duration-200">
                        Mentions légales
                    </a>
                </div>
            </div>
