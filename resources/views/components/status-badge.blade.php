...
@php
    ...
    $themeMap = [
        'programme' => 'text-blue-400 bg-blue-400/20',
        'confirme' => 'text-green-400 bg-green-400/20',
        'en_attente' => 'text-yellow-400 bg-yellow-400/20',
        'termine' => 'text-gray-400 bg-gray-400/20',
        'annule' => 'text-red-400 bg-red-400/20',
        ...
        'dismissed' => 'text-gray-400 bg-gray-900/30',
    ];

    $labelMap = [
        'programme' => __('Programme'),
        'confirme' => __('Confirme'),
    ...
    $themeClass = $themeMap[$statusKey] ?? 'text-slate-300 bg-slate-500/20';
