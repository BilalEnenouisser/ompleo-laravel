...
<section class="relative py-28 px-4 bg-[#e0e3df] dark:bg-[#1f1f1f] overflow-hidden">
    ...
    <div class="relative z-10 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-10">
        ...
        <div class="relative md:bg-white/80 md:dark:bg-[#2b2b2b]/80 md:border md:border-white/30 md:dark:border-[#333333]/50 md:shadow-xl md:backdrop-blur-md md:rounded-[2rem_0.5rem_2rem_0.5rem] p-4 md:p-8 md:transition-all md:duration-500 md:hover:scale-105 md:hover:rotate-[-1deg] md:hover:shadow-2xl scroll-animate" data-animate="card" data-delay="{{ $index * 0.1 }}">
