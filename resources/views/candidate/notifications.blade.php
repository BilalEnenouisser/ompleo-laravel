...
<body class="font-sans antialiased min-h-screen bg-[#1f1f1f] dark">
    ...
    <script>
        ...
        document.getElementById('loadMoreBtn')?.addEventListener('click', function() {
            ...
            fetch(`{{ route('candidate.notifications') }}?page=${currentPage + 1}&search=${encodeURIComponent(search)}&filter=${encodeURIComponent(filter)}`, {
                headers: {
            ...
            .then(data => {
                ...
                // The partial returns notification-card divs which have specific classes
