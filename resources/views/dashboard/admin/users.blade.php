...
<div class="space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
            <button class="bg-[#2b2b2b] border border-[#333333] text-[#9ca3af] hover:text-[#00b6b4] px-3 sm:px-4 py-2 flex items-center justify-center gap-2 rounded-lg transition-colors text-sm sm:text-base">
            ...
            <button class="bg-[#00b6b4] hover:bg-[#009e9c] text-white px-3 sm:px-4 py-2 flex items-center justify-center gap-2 rounded-lg transition-colors text-sm sm:text-base">
                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"/>
                    <path d="M12 5v14"/>
                </svg>
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div class="relative">
                <select class="w-full px-4 py-2 sm:py-3 border border-[#444444] rounded-lg focus:ring-2 focus:ring-[#00b6b4] focus:border-[#00b6b4] outline-none appearance-none bg-[#333333] text-[#f5f5f5] text-sm sm:text-base">
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        ...
                        <td class="py-4 px-6">
                            <div class="space-y-1">
                                ...
                                <div class="text-xs text-[#999999]">IMPACTOME</div>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <span class="px-2 py-1 rounded-full text-xs font-medium text-green-600 bg-green-100">
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        ...
                        <td class="py-4 px-6">
                            <div class="space-y-1">
                                ...
                                <div class="text-xs text-[#999999]">CONDOR</div>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <span class="px-2 py-1 rounded-full text-xs font-medium text-green-600 bg-green-100">
