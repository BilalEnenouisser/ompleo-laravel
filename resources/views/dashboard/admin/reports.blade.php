...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Total</p>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">En attente</p>
                ...
                <div class="w-12 h-12 bg-yellow-900/30 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-yellow-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">En cours</p>
                ...
                <div class="w-12 h-12 bg-blue-900/30 rounded-xl flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye w-6 h-6 text-blue-400"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Résolus</p>
                ...
                <div class="w-12 h-12 bg-green-900/30 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-green-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Rejetés</p>
                    <p class="text-2xl font-bold" style="color: rgb(156 163 175 / var(--tw-text-opacity, 1));">3</p>
                </div>
                <div class="w-12 h-12 rounded-xl flex items-center justify-center" style="background-color: rgb(17 24 39 / 0.3);">
                    <svg class="w-6 h-6" style="color: rgb(156 163 175 / var(--tw-text-opacity, 1));" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="12" cy="12" r="10"/>
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="relative">
                <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#cccccc] w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="relative">
                ...
                <select class="w-full pl-10 pr-8 py-3 border border-[#444444] rounded-lg focus:ring-2 focus:ring-[#00b6b4] focus:border-[#00b6b4] outline-none appearance-none bg-[#333333] text-[#f5f5f5]">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Signalé par :</p>
                            <p class="font-medium text-[#f5f5f5]">Recruiter User</p>
                            <p class="text-sm text-[#00b6b4]">IMPACTOME</p>
                        </div>
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Motif :</p>
                    ...
                    <div class="bg-[#333333] border border-[#444444] rounded-lg p-4 mb-4">
                        <p class="text-sm text-[#cccccc] mb-2">Description :</p>
                        <p class="text-[#f5f5f5]">Les informations du profil semblent fictives, pas de cohérence dans l'expérience.</p>
                    </div>
                </div>

                <div class="flex flex-col gap-3 min-w-[200px]">
                    <button onclick="openActionModal('dismiss', 'Ahmed Belkacem')" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
                    ...
                    <button onclick="openActionModal('warn', 'Ahmed Belkacem')" class="bg-yellow-600 hover:bg-yellow-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button onclick="openActionModal('suspend', 'Ahmed Belkacem')" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button onclick="openActionModal('delete', 'Ahmed Belkacem')" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 6h18"/>
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Signalé par :</p>
                            <p class="font-medium text-[#f5f5f5]">Recruiter User</p>
                            <p class="text-sm text-[#00b6b4]">CONDOR</p>
                        </div>
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Motif :</p>
                    ...
                    <div class="bg-[#333333] border border-[#444444] rounded-lg p-4 mb-4">
                        <p class="text-sm text-[#cccccc] mb-2">Description :</p>
                        <p class="text-[#f5f5f5]">Photo de profil non professionnelle et commentaires déplacés.</p>
                    </div>

                    <div class="bg-green-900/20 border border-green-800 rounded-lg p-4">
                        <p class="text-sm text-green-400 mb-1">Action prise :</p>
                        <p class="text-[#f5f5f5] font-medium">Avertissement envoyé</p>
                        <p class="text-sm text-[#cccccc] mt-2">Premier avertissement envoyé. Profil surveillé.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Signalé par :</p>
                            <p class="font-medium text-[#f5f5f5]">Recruiter User</p>
                            <p class="text-sm text-[#00b6b4]">SONATRACH</p>
                        </div>
                        <div>
                            <p class="text-sm text-[#cccccc] mb-1">Motif :</p>
                    ...
                    <div class="bg-[#333333] border border-[#444444] rounded-lg p-4 mb-4">
                        <p class="text-sm text-[#cccccc] mb-2">Description :</p>
                        <p class="text-[#f5f5f5]">Envoi de messages répétitifs et non sollicités.</p>
                    </div>

                    <div class="bg-green-900/20 border border-green-800 rounded-lg p-4">
                        <p class="text-sm text-green-400 mb-1">Action prise :</p>
                        <p class="text-[#f5f5f5] font-medium">Compte suspendu 7 jours</p>
                        <p class="text-sm text-[#cccccc] mt-2">Suspension temporaire appliquée. Utilisateur contacté.</p>
                    </div>
                </div>
            </div>
        </div>
