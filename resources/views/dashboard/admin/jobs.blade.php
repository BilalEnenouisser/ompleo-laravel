...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg sm:text-2xl font-bold text-yellow-600">1</p>
                </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg sm:text-2xl font-bold text-red-600">1</p>
                </div>
                <div class="w-8 h-8 sm:w-12 sm:h-12 bg-red-900/30 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <svg class="w-4 h-4 sm:w-6 sm:h-6 text-red-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="12" cy="12" r="10"/>
                        <path d="m15 9-6 6"/>
                        <path d="m9 9 6 6"/>
                    </svg>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs sm:text-sm text-[#9ca3af]">Suspendues</p>
                    <p class="text-lg sm:text-2xl font-bold text-[#9ca3af]">1</p>
                </div>
                <div class="w-8 h-8 sm:w-12 sm:h-12 bg-[#333333] rounded-lg sm:rounded-xl flex items-center justify-center">
                    <svg class="w-4 h-4 sm:w-6 sm:h-6 text-[#9ca3af]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="12" cy="12" r="10"/>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs sm:text-sm text-[#9ca3af]">À modérer</p>
                    <p class="text-lg sm:text-2xl font-bold text-orange-600">1</p>
                </div>
                <div class="w-8 h-8 sm:w-12 sm:h-12 bg-orange-900/30 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <svg class="w-4 h-4 sm:w-6 sm:h-6 text-orange-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-[#333333]">
                    <tr>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base">Offre</th>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base hidden md:table-cell">Entreprise</th>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base">Statut</th>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base hidden lg:table-cell">Modération</th>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base hidden xl:table-cell">Performance</th>
                        <th class="text-left py-3 sm:py-4 px-3 sm:px-6 font-semibold text-[#f5f5f5] text-sm sm:text-base hidden xl:table-cell">Dates</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div>
                                <div class="font-semibold text-[#f5f5f5] flex flex-wrap items-center gap-2 text-sm sm:text-base">
                                    <span class="truncate">Développeur Frontend React</span>
                                    <span class="bg-yellow-100 text-yellow-600 px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap">Vedette</span>
                                </div>
                                <div class="text-xs sm:text-sm text-[#9ca3af] flex flex-wrap items-center gap-2 sm:gap-4 mt-1">
                                ...
                                <div class="md:hidden mt-2 space-y-1">
                                    <div class="font-medium text-[#f5f5f5] text-sm">IMPACTOME</div>
                                    <div class="text-xs text-[#9ca3af]">80,000 - 120,000 DA</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden md:table-cell">
                            ...
                            <div class="text-xs sm:text-sm text-[#9ca3af]">80,000 - 120,000 DA</div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                        ...
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden xl:table-cell">
                            <div class="space-y-1">
                                <div class="flex items-center gap-1 text-xs sm:text-sm text-[#9ca3af]">
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div>
                                ...
                                <div class="md:hidden mt-2 space-y-1">
                                    <div class="font-medium text-[#f5f5f5] text-sm">OMPLEO</div>
                                    <div class="text-xs text-[#9ca3af]">70,000 - 100,000 DA</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden md:table-cell">
                            <div class="font-medium text-[#f5f5f5] text-sm sm:text-base">OMPLEO</div>
                            <div class="text-xs sm:text-sm text-[#9ca3af]">70,000 - 100,000 DA</div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <span class="px-2 py-1 rounded-full text-xs font-medium text-green-600 bg-green-100">
                                Actif
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div>
                                ...
                                <div class="md:hidden mt-2 space-y-1">
                                    <div class="font-medium text-[#f5f5f5] text-sm">CONDOR</div>
                                    <div class="text-xs text-[#9ca3af]">60,000 - 80,000 DA</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden md:table-cell">
                            <div class="font-medium text-[#f5f5f5] text-sm sm:text-base">CONDOR</div>
                            <div class="text-xs sm:text-sm text-[#9ca3af]">60,000 - 80,000 DA</div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div>
                                ...
                                <div class="md:hidden mt-2 space-y-1">
                                    <div class="font-medium text-[#f5f5f5] text-sm">TechCorp</div>
                                    <div class="text-xs text-[#9ca3af]">100,000 - 150,000 DA</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden md:table-cell">
                            <div class="font-medium text-[#f5f5f5] text-sm sm:text-base">TechCorp</div>
                            <div class="text-xs sm:text-sm text-[#9ca3af]">100,000 - 150,000 DA</div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                        ...
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div class="flex items-center gap-1 sm:gap-2">
                                <button class="p-1.5 sm:p-2 text-[#9ca3af] hover:text-green-600 transition-colors duration-200">
                                    <svg class="w-3 h-3 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                                        <path d="M22 4 12 14.01l-3-3"/>
                                    </svg>
                    ...
                    <tr class="border-b border-[#444444] hover:bg-[#333333]">
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
                            <div>
                                ...
                                <div class="md:hidden mt-2 space-y-1">
                                    <div class="font-medium text-[#f5f5f5] text-sm">DataCorp</div>
                                    <div class="text-xs text-[#9ca3af]">90,000 - 130,000 DA</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6 hidden md:table-cell">
                            <div class="font-medium text-[#f5f5f5] text-sm sm:text-base">DataCorp</div>
                            <div class="text-xs sm:text-sm text-[#9ca3af]">90,000 - 130,000 DA</div>
                        </td>
                        <td class="py-3 sm:py-4 px-3 sm:px-6">
