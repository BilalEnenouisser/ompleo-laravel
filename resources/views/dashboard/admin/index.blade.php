...
<div class="w-full space-y-4 md:space-y-8">
            <!-- Welcome Section -->
            <div class="bg-gradient-to-r from-[#00b6b4] to-[#009e9c] rounded-xl md:rounded-2xl p-4 md:p-8 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 text-white drop-shadow-sm">
                            Tableau de bord Administrateur 👋
                        </h1>
                        <p class="text-white/90 text-sm md:text-lg drop-shadow-sm">
                            Vue d'ensemble de la plateforme OMPLEO
                        </p>
                    </div>
                    <div class="hidden sm:block">
                        <div class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                            <svg class="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                <button class="bg-[#2b2b2b] border border-[#333333] rounded-lg md:rounded-xl p-3 md:p-4 hover:bg-[#333333] transition-all duration-300 flex items-center gap-2 md:gap-3 hover:scale-105">
                    ...
                    <div class="text-left min-w-0">
                        <div class="font-medium text-[#f5f5f5] text-sm md:text-base">Créer un article</div>
                        <div class="text-xs md:text-sm text-[#cccccc]">Blog</div>
                    </div>
                </button>
                ...
                <button class="bg-[#2b2b2b] border border-[#333333] rounded-lg md:rounded-xl p-3 md:p-4 hover:bg-[#333333] transition-all duration-300 flex items-center gap-2 md:gap-3 hover:scale-105">
                    ...
                    <div class="text-left min-w-0">
                        <div class="font-medium text-[#f5f5f5] text-sm md:text-base">Notification</div>
                        <div class="text-xs md:text-sm text-[#cccccc]">Envoyer</div>
                    </div>
                </button>
                ...
                <button class="bg-[#2b2b2b] border border-[#333333] rounded-lg md:rounded-xl p-3 md:p-4 hover:bg-[#333333] transition-all duration-300 flex items-center gap-2 md:gap-3 hover:scale-105">
                    ...
                    <div class="text-left min-w-0">
                        <div class="font-medium text-[#f5f5f5] text-sm md:text-base">Exporter stats</div>
                        <div class="text-xs md:text-sm text-[#cccccc]">Excel/PDF</div>
                    </div>
                </button>
                ...
                <button class="bg-[#2b2b2b] border border-[#333333] rounded-lg md:rounded-xl p-3 md:p-4 hover:bg-[#333333] transition-all duration-300 flex items-center gap-2 md:gap-3 hover:scale-105">
                    ...
                    <div class="text-left min-w-0">
                        <div class="font-medium text-[#f5f5f5] text-sm md:text-base">Analytics</div>
                        <div class="text-xs md:text-sm text-[#cccccc]">Détaillées</div>
                    </div>
                </button>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                <!-- Utilisateurs totaux -->
                <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-3 md:mb-4">
                        <div class="bg-[#00b6b4]/10 text-[#00b6b4] w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl flex items-center justify-center">
                            <svg class="w-5 h-5 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 md:mb-6 gap-4">
                    <h2 class="text-lg md:text-xl font-bold text-[#f5f5f5] flex items-center gap-2 md:gap-3">
                        <svg class="w-5 h-5 md:w-6 md:h-6 text-[#00b6b4]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M22 12h-4l-3 9L9 3l-3 9H2"/>
                        </svg>
                ...
                <div class="space-y-2 md:space-y-3 max-h-80 md:max-h-96 overflow-y-auto">
                    <div class="flex items-start md:items-center gap-3 md:gap-4 p-3 md:p-4 bg-[#333333] border border-[#444444] rounded-lg hover:bg-[#3a3a3a] transition-colors">
                        ...
                        <button class="p-1 md:p-2 text-[#cccccc] hover:text-[#00b6b4] transition-colors flex-shrink-0">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Actions en attente -->
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg">
                <h2 class="text-lg md:text-xl font-bold text-[#f5f5f5] mb-4 md:mb-6">
                    Actions en attente
                </h2>
