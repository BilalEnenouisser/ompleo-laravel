...
<div class="space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <button class="bg-[#333333] hover:bg-[#444444] text-[#f5f5f5] px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Revenus totaux</p>
                    <p class="text-2xl font-bold text-[#f5f5f5]">
                        179,000 DA
                    </p>
                </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Transactions</p>
                    <p class="text-2xl font-bold text-[#f5f5f5]">5</p>
                </div>
                <div class="w-12 h-12 bg-blue-900/30 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-blue-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Complétés</p>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-[#cccccc]">Échoués</p>
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2 text-green-400">
                ...
                <span class="font-medium">+12.5% ce mois</span>
            </div>
        </div>
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-[#f5f5f5]">
                            156,000 DA
                        </p>
                        <p class="text-sm text-[#9ca3af]">Revenus du mois</p>
                    </div>
                </div>
                <div class="w-32 h-2 bg-[#333333] rounded-full overflow-hidden">
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button class="bg-[#00b6b4] hover:bg-[#009999] text-white px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-[#333333]">
                    <tr>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Transaction</th>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Entreprise</th>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Montant</th>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Méthode</th>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Statut</th>
                        <th class="text-left py-4 px-6 font-semibold text-[#f5f5f5]">Date</th>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <button class="bg-[#333333] hover:bg-[#444444] text-[#f5f5f5] px-4 py-2 rounded-lg transition-colors">Précédent</button>
            <button class="bg-[#333333] hover:bg-[#444444] text-[#f5f5f5] px-4 py-2 rounded-lg transition-colors">Suivant</button>
        </div>
    </div>
</div>
@endsection
