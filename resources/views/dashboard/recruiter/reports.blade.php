...
<div class="space-y-4 sm:space-y-6 md:space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <button class="px-2 sm:px-3 md:px-4 py-2 border border-[#444444] rounded-lg text-[#9ca3af] hover:bg-[#333333] transition-colors flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base">
            ...
            <button class="bg-[#00b6b4] hover:bg-[#009999] text-white px-2 sm:px-3 md:px-4 py-2 rounded-lg transition-colors flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base">
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg">
        <div class="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4 md:mb-6">
            <button id="overviewTab" class="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg font-medium transition-colors bg-[#00b6b4] text-white text-xs sm:text-sm md:text-base">
                <span class="hidden sm:inline">Vue d'ensemble</span>
                <span class="sm:hidden">Vue d'ensemble</span>
            </button>
            <button id="jobsTab" class="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg font-medium transition-colors bg-[#333333] text-[#9ca3af] hover:bg-[#444444] text-xs sm:text-sm md:text-base">
                <span class="hidden sm:inline">Performance des offres</span>
                <span class="sm:hidden">Offres</span>
            </button>
            <button id="candidatesTab" class="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg font-medium transition-colors bg-[#333333] text-[#9ca3af] hover:bg-[#444444] text-xs sm:text-sm md:text-base">
                <span class="hidden sm:inline">Analyse candidats</span>
                <span class="sm:hidden">Candidats</span>
            </button>
            <button id="trendsTab" class="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg font-medium transition-colors bg-[#333333] text-[#9ca3af] hover:bg-[#444444] text-xs sm:text-sm md:text-base">
                <span class="hidden sm:inline">Tendances</span>
                <span class="sm:hidden">Tendances</span>
            </button>
        </div>
    </div>

    {{-- Overview Stats --}}
    <div id="overviewContent" class="space-y-4 sm:space-y-6 md:space-y-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5] mb-1">{{ $stats['total_jobs'] }}</h3>
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5] mb-1">{{ $stats['total_applications'] }}</h3>
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5] mb-1">{{ number_format($stats['total_views']) }}</h3>
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5] mb-1">{{ $stats['conversion_rate'] }}%</h3>
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            <div class="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-[#00b6b4]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                <span class="font-bold text-[#00b6b4] text-xs sm:text-sm">{{ $trend['month'] }}</span>
                            </div>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-[#f5f5f5] text-xs sm:text-sm md:text-base truncate">{{ $trend['applications'] }} candidatures</p>
                                <p class="text-xs sm:text-sm text-[#9ca3af] truncate">{{ number_format($trend['views']) }} vues</p>
                            </div>
                        </div>
                        <div class="w-16 sm:w-20 md:w-24 h-2 bg-[#333333] rounded-full overflow-hidden flex-shrink-0 ml-2">
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg">
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div class="space-y-1.5 sm:space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="text-xs sm:text-sm font-medium text-[#f5f5f5] truncate">{{ $source['name'] }}</span>
                            <span class="text-xs sm:text-sm text-[#9ca3af] flex-shrink-0 ml-2">{{ $source['count'] }} candidats</span>
                        </div>
                ...
                <table class="w-full min-w-[600px]">
                    <thead>
                        <tr class="border-b border-[#333333]">
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Offre</th>
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Vues</th>
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Candidatures</th>
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Taux conversion</th>
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Statut</th>
                            <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-[#f5f5f5] text-xs sm:text-sm">Date</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-b border-[#333333] hover:bg-[#333333]">
                            <td class="py-3 sm:py-4 px-2 sm:px-4">
                                <div class="font-medium text-[#f5f5f5] text-xs sm:text-sm truncate">{{ $job['title'] }}</div>
                            </td>
                            <td class="py-3 sm:py-4 px-2 sm:px-4 text-[#9ca3af] text-xs sm:text-sm">{{ $job['views'] }}</td>
                            <td class="py-3 sm:py-4 px-2 sm:px-4 text-[#9ca3af] text-xs sm:text-sm">{{ $job['applications'] }}</td>
                            <td class="py-3 sm:py-4 px-2 sm:px-4">
                                <span class="font-medium text-[#f5f5f5] text-xs sm:text-sm">{{ $job['conversion_rate'] }}</span>
                            </td>
                            <td class="py-3 sm:py-4 px-2 sm:px-4">
                                <span class="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-medium {{ $job['status'] == 'Actif' ? 'text-green-400 bg-green-400/20' : 'text-red-400 bg-red-400/20' }}">
                                    {{ $job['status'] }}
                                </span>
                            </td>
                            <td class="py-3 sm:py-4 px-2 sm:px-4 text-[#9ca3af] text-xs sm:text-sm">{{ $job['date'] }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="py-6 sm:py-8 px-4 text-center text-[#9ca3af] text-xs sm:text-sm">
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg">
                ...
                <div class="space-y-3 sm:space-y-4">
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-blue-400/20 rounded-lg">
                        ...
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-blue-400 flex-shrink-0 ml-2">{{ $stats['application_status']['pending'] }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-green-400/20 rounded-lg">
                        ...
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-green-400 flex-shrink-0 ml-2">{{ $stats['application_status']['accepted'] }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-red-400/20 rounded-lg">
                        ...
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-red-400 flex-shrink-0 ml-2">{{ $stats['application_status']['rejected'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg">
                ...
                <div class="space-y-4 sm:space-y-6">
                    <div class="text-center">
                        <div class="text-2xl sm:text-3xl md:text-4xl font-bold text-[#00b6b4] mb-1 sm:mb-2">{{ $stats['response_time'] }} jours</div>
                        <p class="text-xs sm:text-sm text-[#9ca3af]">Temps moyen de première réponse</p>
                    </div>
                    
                    <div class="grid grid-cols-2 gap-2 sm:gap-4">
                        <div class="text-center p-3 sm:p-4 bg-[#333333] rounded-lg">
                            <div class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5]">1.8j</div>
                            <p class="text-xs sm:text-sm text-[#9ca3af]">Le plus rapide</p>
                        </div>
                        <div class="text-center p-3 sm:p-4 bg-[#333333] rounded-lg">
                            <div class="text-lg sm:text-xl md:text-2xl font-bold text-[#f5f5f5]">4.2j</div>
                            <p class="text-xs sm:text-sm text-[#9ca3af]">Le plus lent</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- Trends --}}
    <div id="trendsContent" class="hidden space-y-4 sm:space-y-6 md:space-y-8">
        {{-- Charts Row 1 --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            ...
            <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-[300px]">
                        <thead>
                            <tr class="border-b border-[#333333]">
                                <th class="text-left py-2 sm:py-3 px-2 text-xs sm:text-sm font-medium text-[#9ca3af]">Catégorie</th>
                                <th class="text-right py-2 sm:py-3 px-2 text-xs sm:text-sm font-medium text-[#9ca3af]">Offres</th>
                                <th class="text-right py-2 sm:py-3 px-2 text-xs sm:text-sm font-medium text-[#9ca3af]">Vues</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($stats['trends']['job_categories'] as $category)
                            <tr class="border-b border-[#333333]/50">
                                <td class="py-2 sm:py-3 px-2 text-xs sm:text-sm text-[#f5f5f5] truncate">{{ $category['category'] }}</td>
                                <td class="py-2 sm:py-3 px-2 text-xs sm:text-sm text-[#f5f5f5] text-right">{{ $category['jobs'] }}</td>
                                <td class="py-2 sm:py-3 px-2 text-xs sm:text-sm text-[#f5f5f5] text-right">{{ number_format($category['views']) }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="3" class="py-6 sm:py-8 text-center text-[#9ca3af] text-xs sm:text-sm">Aucune donnée disponible</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-[#00b6b4]/10 rounded-lg">
                        <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs sm:text-sm text-[#9ca3af]">Toutes les candidatures reçues</p>
                            </div>
                        </div>
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-[#00b6b4] flex-shrink-0 ml-2">{{ $stats['total_applications'] }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-green-400/10 rounded-lg">
                        <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs sm:text-sm text-[#9ca3af]">Candidatures / Vues</p>
                            </div>
                        </div>
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-green-400 flex-shrink-0 ml-2">{{ $stats['conversion_rate'] }}%</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-blue-400/10 rounded-lg">
                        <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs sm:text-sm text-[#9ca3af]">Offres publiées</p>
                            </div>
                        </div>
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-blue-400 flex-shrink-0 ml-2">{{ $stats['total_jobs'] }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 sm:p-4 bg-purple-400/10 rounded-lg">
                        <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs sm:text-sm text-[#9ca3af]">Toutes les vues d'offres</p>
                            </div>
                        </div>
                        <span class="text-lg sm:text-xl md:text-2xl font-bold text-purple-400 flex-shrink-0 ml-2">{{ number_format($stats['total_views']) }}</span>
                    </div>
                </div>
            </div>
        </div>
