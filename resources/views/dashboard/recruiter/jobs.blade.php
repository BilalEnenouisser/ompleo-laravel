...
<div class="space-y-6 sm:space-y-8">
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-[#f5f5f5]">{{ $totalJobs }}</p>
                </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-green-400">{{ $activeJobs }}</p>
                </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-red-400">{{ $expiredJobs }}</p>
                </div>
        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-4 sm:p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-[#9ca3af]">{{ $draftJobs }}</p>
                </div>
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-[#333333] rounded-xl flex items-center justify-center">
    ...
    <div class="space-y-4 sm:space-y-6">
        @forelse($jobs as $job)
        <div class="bg-[#2b2b2b] border {{ $job->is_featured ? 'border-[#00b6b4]/30 ring-2 ring-[#00b6b4]/20' : 'border-[#333333]' }} rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex flex-col lg:flex-row lg:items-center gap-4 sm:gap-6">
                <div class="flex-1">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <span class="px-2 sm:px-3 ml-4 py-1 rounded-full text-xs sm:text-sm font-medium 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-xs sm:text-sm text-[#9ca3af] mb-3 sm:mb-4">
                        <div class="flex items-center gap-1 sm:gap-2">
                            ...
                            <span>{{ $job->type ?? 'Non spécifié' }}</span>
                        </div>
                        <div class="flex items-center gap-1 sm:gap-2">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="flex items-center gap-1 sm:gap-2">
                            <span>🏠</span>
                            <span>{{ ucfirst($job->work_type ?? 'Non spécifié') }}</span>
                        </div>
                        <div class="flex items-center gap-1 sm:gap-2">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span>@if($job->application_deadline) Expire le {{ \Carbon\Carbon::parse($job->application_deadline)->format('Y-m-d') }} @else Pas de date limite @endif</span>
                        </div>
                    </div>
