...
@section('title', 'Paramètres - Candidat - OMPLEO')
...
<div class="space-y-4 sm:space-y-6 md:space-y-8">
    ...
    <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg">
        <form method="POST" action="{{ route('candidate.settings.update') }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-[#444444]">
                <a href="{{ route('candidate.dashboard') }}" class="px-4 py-2 border border-[#444444] rounded-lg text-[#9ca3af] hover:bg-[#333333] transition-colors">
                    Annuler
                </a>
                <button 
                    type="submit" 
