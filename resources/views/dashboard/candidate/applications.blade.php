        ...
        <div class="bg-[#2b2b2b] border border-[#333333] rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                <div class="flex items-start gap-4 flex-1">
                    ...
                    <div class="flex-1">
                        <div class="flex items-start justify-between mb-2">
                            ...
                            @endphp
                            <span class="px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 {{ $status['class'] }}">
                                ...
                                @else
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>
                                @endif
                                {{ $status['text'] }}
                            </span>
                        </div>
                ...
                <div class="flex items-center gap-3 lg:flex-col lg:items-end">
                    <a href="{{ route('jobs.show', $application->job->slug) }}" class="px-4 py-2 border border-[#444444] rounded-lg text-[#9ca3af] hover:bg-[#333333] transition-colors flex items-center gap-2">
