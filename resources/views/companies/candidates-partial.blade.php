@foreach($candidates as $candidate)
    @if($candidate->candidateProfile)
        ...
        <div class="bg-white dark:bg-[#2b2b2b] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-[#333333] flex flex-col">
            ...
            {{-- Button at Bottom --}}
            <a href="{{ route('candidates.show', $candidate->id) }}" class="w-full bg-[#00b6b4] hover:bg-[#009999] text-white py-2.5 rounded-lg transition-colors text-center font-semibold text-sm mt-auto">
                Voir le profils
            </a>
        </div>
    @endif
